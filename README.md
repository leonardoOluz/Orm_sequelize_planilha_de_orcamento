...
Esta API foi desenvolvida em NodeJs, usando os frameworks: sequelize 6.28.0, sequelize-cli 6.6.0, express 4.18.2, mysql2 3.0.1 e body-parser 1.20.1.
Nesta API, foi sugerido alguns campos de despesas e receitas conforme o trabalho solicitado no trello.
Segue os backLogs solicitado.


` Obs: Foi pedido pela equipe que, o acesso da planilha fosse feito apenas por usuário cadastrado. Pórem, esta versão em sequelize, resolvi deixar uma planilha de orçamento individual por usuário. O projeto contínua em desevolvimento`
